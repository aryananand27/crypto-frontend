    ...
    <Stack direction="row" alignItems="center" p={2} sx={{position:
        "sticky",background:"#000",top:"0",justifyContent:"space-between"}}>
            <Link to="/" style={{display:"flex",alignItems:"center"}} >
                ...
                <Typography sx={{color:"#fff",paddingLeft:{sm:"4px",md:"4px",lg:"6px"},fontWeight:"bold",fontSize:{xs:"14px",sm:"18px",md:"20px",lg:"30px"}}} >CryptoApp</Typography>
               
            </Link>
            <div>
            {auth? <>
            
            <Link to='/alarm'> <button className='btn1'><Tooltip title="Set Alarm"><AddAlarmIcon /> </Tooltip> </button></Link>
